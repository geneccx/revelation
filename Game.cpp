...
#include "JASS.h"
  g_Revelation->m_Game->TextOut(/*"Revelation v1.0 by Zephyrix is active."); */
    XorStr<0x4F, 39, 0x675FA9CA>(&"\x1D\x35\x27\x37\x3F\x35\x21\x3F\x38\x36\x79\x2C\x6A\x72\x6D\x7E\x3D\x19\x41\x38\x06\x14\x0D\x1F\x15\x01\x11\x4A\x02\x1F\x4D\x0F\x0C\x04\x18\x04\x16\x5A"[0] + 0x675FA9CA).s);
